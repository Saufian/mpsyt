	...
	if(c == 2)
			{
					...
					sleep(1);
				system("apt-get install -y python-setuptools && apt-get install -y python3-setuptools");
					...
					sleep(1);
				system("cd /root/mpsyt/mps-youtube/ && python3 setup.py build");
					sleep(1);
				system("cd /root/mpsyt/mps-youtube/ && python3 setup.py install");
					sleep(3);
	...
	void system2()
	{
		...
		system("pkg install -y wget");
			...
			sleep(1);
				printf("\t \t \t >>>>>> installing Mpsyt  >>>>>>\n \n \n");
			sleep(1);
		system("cd $HOME/mpsyt/mps-youtube/ && python3 setup.py build");
			sleep(1);
		system("cd $HOME/mpsyt/mps-youtube/ && python3 setup.py install");
			sleep(3);
				printf("\t \t \t >>>>>> Installation Completed  >>>>>>\n \n \n");
	}
///////////////////////////////////////////////////////////////////////////////////////////////////
